...
function DrawingCanvas() {
  ...
  const predictTimeout = useRef(null);
  ...
  const queuePrediction = () => {
    clearTimeout(predictTimeout.current);
  ...
  const predictDigit = async () => {
    ...
    try {
      const res = await fetch("https://digit-predictor-d7qz.onrender.com", {
      method: "POST",
  ...
  return (
    <div style={{
      ...
      margin: "40px auto",
      padding: 30,
      background: "repeating-linear-gradient(white, white 22px, #e0e0e0 23px, white 24px)",
